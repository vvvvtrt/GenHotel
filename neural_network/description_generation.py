...
if __name__ == '__main__':
    ...
    print(generate_text("""перепиши другими словами, выделяя важное и обязательно используя слово "шведский стол" и не используя слова "метро": 
...
Все номера сети «Космос» оформлены в едином лаконичном стиле, а кровати – с ортопедическим матрасом. Здесь усиленная шумоизоляция, чтобы гостям ничего не мешало отдыхать. Также доступны номера для гостей с ограниченными возможностями.
